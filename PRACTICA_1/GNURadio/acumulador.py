...
class acumulador(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_throttle2_0 = blocks.throttle( gr.sizeof_float*1, samp_rate, True, 0 if "items" == "auto" else max( int(float(0.1) * samp_rate) if "items" == "time" else int(0.1), 1) )
