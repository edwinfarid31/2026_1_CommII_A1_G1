...
# Title: Estacion de medicion estadistica
# Author: Edwin Farid Bolaño Perez
...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Estacion de medicion estadistica", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Estacion de medicion estadistica")
