...
\lipsum[1] Según \cite{referencia1}, la radio definida por software es clave.

\section{Metodología}
\lipsum[2] 

\subsection{Configuración de GNURadio}
Como se observa en la Tabla 1, los parámetros deben ser precisos.
\lipsum[3]

\subsubsection{Bloques de procesamiento} 
Aquí se detallan los bloques específicos utilizados en el diagrama de flujo de GNU Radio.

% Ejemplo de Tabla (dentro de multicols no flota, se usa center)
\begin{center}
    \small
    \begin{tabular}{lcr}
        \toprule
    ...
    \end{tabular}
    \\[5pt]
    \textit{Tabla 1: Parámetros del sistema.}
\end{center}
