...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.digital_chunks_to_symbols_xx_0 = digital.chunks_to_symbols_bc([1, 0.707+0.707j, 0+1j, -0.707+0.707j, -1, -0.707-0.707j, 0-1j, 0.707-0.707j], 1)
        self.blocks_repack_bits_bb_0_0 = blocks.repack_bits_bb(1, Nbs, "", False, gr.GR_LSB_FIRST)
        ...
        self.connect((self.interp_fir_filter_xxx_0_0, 0), (self.blocks_add_xx_0_0, 1))
    ...
    def set_Nbs(self, Nbs):
        ...
        self.blocks_repack_bits_bb_0_0.set_k_and_l(1,self.Nbs)
